import type { EVMResult, IotaAggregatorResponse, IotaSimulationResult, SuiAggregatorResponse, SuiSimulationResult } from './types/chains.js';
import type { CrossbarFetchResponse, CrossbarOracleFeedFetchResponse, CrossbarSimulateProtoResponse, FeedRequest, FetchSignaturesConsensusRequest, FetchSignaturesConsensusResponse, FetchSignaturesRequest, OracleInfo, SimulateJobsRequest, SimulateJobsResponse, V2UpdateQuery, V2UpdateResponse } from './types/crossbar.js';
 ...
 */
export declare enum CrossbarNetwork {
...
export declare class CrossbarClient {
     ...
     */
    fetchOracleQuote(aggregatorIds: string[], network?: string): Promise<V2UpdateResponse & {
        encoded: string;
    }>;
    /**
     ...
     * ```
     */
    fetchGateway(network?: string): Promise<Gateway>;
    /**
     * GET /oracles
     ...
     * );
     */
    simulateFeed(feedOrHash: IOracleFeed | string, includeReceipts?: boolean, variableOverrides?: Record<string, string>, network?: string): Promise<CrossbarSimulateProtoResponse>;
    /**
     ...
     */
    simulateFeeds(feedHashes: string[], includeReceipts?: boolean): Promise<CrossbarSimulateProtoResponse[]>;
    /**
     ...
     * @returns {Promise<CrossbarSimulateProtoResponse[]>} - The simulated feed results
     */
    simulateOracleFeeds(feedHashes: string[], includeReceipts?: boolean, variableOverrides?: Record<string, string>, network?: string): Promise<CrossbarSimulateProtoResponse[]>;
}
//# sourceMappingURL=crossbar-client.d.ts.map