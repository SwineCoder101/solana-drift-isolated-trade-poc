...
export namespace oracle_job {
    ...
    namespace OracleJob {
        ...
        /** Properties of a HyloTask. */
        interface IHyloTask {

            /** The Hylo token to convert from (defaults to hyUSD) */
            token?: (oracle_job.OracleJob.HyloTask.Token|null);
        }
         ...
         */
        class HyloTask implements IHyloTask {

            /**
             * Constructs a new HyloTask.
             * @param [properties] Properties to set
             */
            constructor(properties?: oracle_job.OracleJob.IHyloTask);

            /** The Hylo token to convert from (defaults to hyUSD) */
            public token: oracle_job.OracleJob.HyloTask.Token;

            /**
             * Creates a new HyloTask instance using the specified properties.
             * @param [properties] Properties to set
             * @returns HyloTask instance
             */
            public static create(properties?: oracle_job.OracleJob.IHyloTask): oracle_job.OracleJob.HyloTask;

            /**
             * Encodes the specified HyloTask message. Does not implicitly {@link oracle_job.OracleJob.HyloTask.verify|verify} messages.
             * @param message HyloTask message or plain object to encode
             * @param [writer] Writer to encode to
             * @returns Writer
             */
            public static encode(message: oracle_job.OracleJob.IHyloTask, writer?: $protobuf.Writer): $protobuf.Writer;

            /**
             * Encodes the specified HyloTask message, length delimited. Does not implicitly {@link oracle_job.OracleJob.HyloTask.verify|verify} messages.
             * @param message HyloTask message or plain object to encode
             * @param [writer] Writer to encode to
             * @returns Writer
             */
            public static encodeDelimited(message: oracle_job.OracleJob.IHyloTask, writer?: $protobuf.Writer): $protobuf.Writer;

            /**
             * Decodes a HyloTask message from the specified reader or buffer.
             * @param reader Reader or buffer to decode from
             * @param [length] Message length if known beforehand
             * @returns HyloTask
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): oracle_job.OracleJob.HyloTask;

            /**
             * Decodes a HyloTask message from the specified reader or buffer, length delimited.
             * @param reader Reader or buffer to decode from
             * @returns HyloTask
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): oracle_job.OracleJob.HyloTask;

            /**
             * Verifies a HyloTask message.
             * @param message Plain object to verify
             * @returns `null` if valid, otherwise the reason why it is not
             */
            public static verify(message: { [k: string]: any }): (string|null);
            ...
            /**
             * Creates a HyloTask message from a plain object. Also converts values to their respective internal types.
             * @param object Plain object
             * @returns HyloTask
             */
            public static fromObject(object: { [k: string]: any }): oracle_job.OracleJob.HyloTask;

            /**
             * Creates a plain object from a HyloTask message. Also converts values to other types if specified.
             * @param message HyloTask
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: oracle_job.OracleJob.HyloTask, options?: $protobuf.IConversionOptions): { [k: string]: any };

            /**
             * Converts this HyloTask to JSON.
             * @returns JSON object
             */
            public toJSON(): { [k: string]: any };

            /**
             * Gets the default type url for HyloTask
             * @param [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns The default type url
             */
            public static getTypeUrl(typeUrlPrefix?: string): string;
         ...
         * ```
         */
        class Blake2b128Task implements IBlake2b128Task {

            /**
             * Constructs a new Blake2b128Task.
             * @param [properties] Properties to set
             */
            constructor(properties?: oracle_job.OracleJob.IBlake2b128Task);

            /** Optional value to hash. If not provided or empty, will use the previous task output. */
            public value: string;

            /**
             * Creates a new Blake2b128Task instance using the specified properties.
             * @param [properties] Properties to set
             * @returns Blake2b128Task instance
             */
            public static create(properties?: oracle_job.OracleJob.IBlake2b128Task): oracle_job.OracleJob.Blake2b128Task;

            /**
             * Encodes the specified Blake2b128Task message. Does not implicitly {@link oracle_job.OracleJob.Blake2b128Task.verify|verify} messages.
             * @param message Blake2b128Task message or plain object to encode
             * @param [writer] Writer to encode to
             * @returns Writer
             */
            public static encode(message: oracle_job.OracleJob.IBlake2b128Task, writer?: $protobuf.Writer): $protobuf.Writer;

            /**
             * Encodes the specified Blake2b128Task message, length delimited. Does not implicitly {@link oracle_job.OracleJob.Blake2b128Task.verify|verify} messages.
             * @param message Blake2b128Task message or plain object to encode
             * @param [writer] Writer to encode to
             * @returns Writer
             */
            public static encodeDelimited(message: oracle_job.OracleJob.IBlake2b128Task, writer?: $protobuf.Writer): $protobuf.Writer;
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): oracle_job.OracleJob.Blake2b128Task;
             ...
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): oracle_job.OracleJob.Blake2b128Task;
             ...
             * @returns Blake2b128Task
             */
            public static fromObject(object: { [k: string]: any }): oracle_job.OracleJob.Blake2b128Task;

            /**
             * Creates a plain object from a Blake2b128Task message. Also converts values to other types if specified.
             * @param message Blake2b128Task
             * @param [options] Conversion options
             * @returns Plain object
             */
            public static toObject(message: oracle_job.OracleJob.Blake2b128Task, options?: $protobuf.IConversionOptions): { [k: string]: any };
        ...
        interface ITask {
            ...
            /** Task blake2b128Task */
            blake2b128Task?: (oracle_job.OracleJob.IBlake2b128Task|null);

            /** Task hyloTask */
            hyloTask?: (oracle_job.OracleJob.IHyloTask|null);
        }
