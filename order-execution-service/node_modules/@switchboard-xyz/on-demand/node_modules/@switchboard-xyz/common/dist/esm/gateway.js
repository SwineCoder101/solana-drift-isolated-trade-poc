...
function encodeJobs(jobs) {
    return jobs.map(job => OracleJobUtils.serializeOracleJob(job).toString('base64'));
}
/**
...
export class Gateway {
    ...
    async fetchSignaturesConsensus(params) {
        ...
        const feedRequests = isV1
            ...
            : feedConfigs.map(config => ({
                feed_proto_b64: OracleFeedUtils.serializeOracleFeed(config.feed).toString('base64'),
            }));
